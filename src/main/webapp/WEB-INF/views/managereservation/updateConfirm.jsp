...
<div class="container">
	...
	<div class="info">
		<spring:message
			code="label.tr.managereservation.manageReservationConfirmScreenFlowMessage" />
	</div>
	<!-- begin message -->
	<spring:message
		code="label.tr.managereservation.manageReservationConfirmDetailMessage" />
	<!-- end message -->
	...
	<br />
	<spring:message
		code="label.tr.managereservation.manageReservationConfirmCautionMessage" />
	<br />
	<hr />
	<table>
		<caption>
