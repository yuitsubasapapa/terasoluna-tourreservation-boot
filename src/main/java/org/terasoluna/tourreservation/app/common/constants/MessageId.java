...
You can also search for tour reservations. You must be logged in to the reservation.</strong>
    ...
    /**
     * <strong>label.tr.menu.loginMessage = 
...
In order to login you must registere members in advance.</strong>
    ...
    /**
     * <strong>label.tr.login.notCustmerMessage = Customers do not have a member ID, please register your membership with the buttons below.</strong>
     */
    ...
    /**
     * <strong>label.tr.managecustomer.createFormMessage = <strong>Membership information input</strong> -> Confirm information -> Completed<br>
...
Please press the input, "Confirm" button when finished.</strong>
    ...
    /**
     * <strong>label.tr.managecustomer.createConfirmMessage = Membership information input -> <strong>Confirm information</strong> -> Completed<br>
...
Please press the confirmation, "Register" button when finished.</strong>
    ...
    /**
     * <strong>label.tr.managecustomer.createCompleteMessage = Membership information input -> Confirm information -> <strong>Completed</strong><br>
Membership registration was completed.
...
<strong>Please do not forget because you will need at login.</strong></strong>
    ...
    /**
     * <strong>label.tr.searchtour.searchTourFlowMessage = <p> <strong>Search Tour</strong> -> Check the contents ⇒ Confirm reservation -> Completed</p>
<p>* registration procedure</p></strong>
     */
    public static final String LABEL_TR_SEARCHTOUR_SEARCHTOURFLOWMESSAGE = "label.tr.searchtour.searchTourFlowMessage";
    /**
     * <strong>label.tr.searchtour.searchTourInstructionsMessage = <ol>
    ...
    <li>Check the contents of the tour in Tour Details screen, please proceed to the next screen if there is no problem. (Reservations are not yet.)</li>
    <li>Confirm your reservation, please perform a reservation if there is no problem.</li>
    <li>For more information please check tour, membership information, fee details, the payment information screen tour reservation registration is complete.</li>
</ol>
<p>Search for tours by specifying the conditions, please select a tour from the search results. The tour can be selected by pressing the link name of the tour.</p></strong>
     */
    ...
    /**
     * <strong>label.tr.searchtour.loginToReserveMessage = Please press the Login button below in order to make the reservation</strong>
     */
    public static final String LABEL_TR_SEARCHTOUR_LOGINTORESERVEMESSAGE = "label.tr.searchtour.loginToReserveMessage";
    /**
     * <strong>label.tr.searchtour.pressReserveBtnMessage = Once the Tour details are confirmed, please press the Reserve button below. </br> Please fill in, if there are any suggestions. </strong>
     */
    ...
    /**
     * <strong>label.tr.searchtour.opinionSuggestionMessage = * If there is opinion or suggestion regarding the tour, please mention it here</strong>
     */
...
Press "Download PDF"button to save the reservation information in PDF format.</strong>
    ...
    /**
     * <strong>label.tr.searchtour.reserveScreenFlowMessage = <br /> Please pay before the due date in the bank account or directly at the window <br />
Further, if payment is not confirmed till the due date, <br /> the reservation can be cancelled. <br />
<br /> Reservation slip can be downloaded in the PDF format.<br /></strong>
     */
    ...
    /**
     * <strong>label.tr.searchtour.reserveDate = Tour Search&nbsp;⇒&nbsp;Tour Details&nbsp;⇒&nbsp;Confirmation of Tour Details&nbsp;⇒&nbsp;<strong>Finish</strong></strong>
     */
    public static final String LABEL_TR_SEARCHTOUR_RESERVEDATE = "label.tr.searchtour.reserveDate";
    /**
     * <strong>label.tr.searchtour.reserveNo = Tour Search&nbsp;⇒&nbsp;Tour Details&nbsp;⇒&nbsp;<strong>Confirmation of Tour Details</strong>&nbsp;⇒&nbsp;Finish</strong>
     */
    public static final String LABEL_TR_SEARCHTOUR_RESERVENO = "label.tr.searchtour.reserveNo";
    /**
     * <strong>label.tr.searchtour.goTourSearchScreenMessage = Tour Search&nbsp;⇒&nbsp;<strong>Tour Details</strong>&nbsp;⇒&nbsp;Confirmation of Tour Details&nbsp;⇒&nbsp;Finish</strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationFlowMessage = <strong>Confirm the List of Reservations </strong>　⇒ Confirm the Details</br></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationNoRecordMessage = For refering the details or making changes to a reservation or canceling a reservation, <br /> press "Check Details", "Edit", "Delete" button resepectively <br /><br /></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationNoCancelMessage = The Tours for which the payment has been done or payment due date has already passed, <br />it cannot be changed or canceled on the web.<br />
Please call at Phone (01-2345-6789) or visit our office.</strong>
    ...
    /**
     * <strong>label.tr.managereservation.ReserveListMessage = Reservation List&nbsp;&nbsp; <font>※Shown in the ascending order of departure and reservation no</font></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.updatedScreenFlowMessage = <font>Edit the contents</font> &nbsp;⇒&nbsp;<font>Confirm the edited contents</font>&nbsp;⇒&nbsp;<font><strong>Finish</strong></font> <br /></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.updatedFinishMessage = The reservation has been changed as below.<br> </strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.paymentReminderMessage =  Please make the payment at the reception or in the bank account before the payment due-date.<br /> Also, please note that if payment is not done by the due-date, it is possible that the reservation may get cancelled.<br />
 Thank you for your understanding<br /></strong>
     */
...
Please visit the travel desk or contact us on phone at (01-2345-6789) for changes and cancellation related procedures<br /></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationShowScreenFlowMessage = <font>Confirm the list of reservations</font>&nbsp;⇒&nbsp; <font><strong>Confirm the details of a Reservation</strong></font></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationShowMessage = Please confirm the detail information of the reservation made by you.<br /></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationUpdatedScreenTitleMessage = Reservation Change Completion Screen</strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationConfirmScreenTitleMessage = Reservation Change Confirmation Screen</strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationConfirmScreenFlowMessage = <font>Make Changes</font> &nbsp;⇒&nbsp;<font><strong>Confirm the Changes</strong></font> &nbsp;⇒&nbsp;<font>Finish</font> <br /></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationConfirmDetailMessage = <p>The changes are as below. <p>If there is no problem with the changed contents, press the "Change Reservation" button below.&nbsp;</p></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationConfirmCautionMessage = <p>Please take a note that, there is no change in the payment information below.</p></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationConfirmMessage = <p>Reservation will be changed according to the information above. Is it OK to proceed ?</p></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationEditFlowMessage = <font><strong>Make Changes</strong></font> &nbsp;⇒&nbsp;<font>Confirm the Changes</font> &nbsp;⇒&nbsp;<font>Finish</font> <br /></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.manageReservationEditMessage = <p>After making changes to the reservation, press the "Confirm Reservation" button below.&nbsp;</p></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.beforecancelScreenTitleMessage = Confirmation Screen for Reservation Cancellation</strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.beforecancelScreenFlowMessage = <strong>Confirm Cancellation Contents</strong>&nbsp;⇒&nbsp;Finish</strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.beforeCancelScreenMessage = Please Press "Cancel Reservation" button below if this reservation is to be cancelled.</strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.aftercancelScreenFlowMessage = Confirm Cancellation Contents&nbsp;⇒&nbsp;<strong>Finish</strong></strong>
     */
    ...
    /**
     * <strong>label.tr.managereservation.aftercancelScreenMessage = Tour Reservation with Reservation Number: {0}, is cancelled.</strong>
     */
